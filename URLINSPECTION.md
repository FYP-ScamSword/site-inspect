...
8. Check for blacklisted keywords in URL
 ...
 > **Note**
 >
 > As this check is heavily dependent on our list of blacklisted keywords, we will work to find out more of these keywords to popular this list.
...
9.  Cybersquatting Checks
  ...
  We implemented checks for the few most common types of Cybersquatting:
  - Homographsquatting
  - Levelsquatting
  - Combosquatting
  - Bitsquatting
